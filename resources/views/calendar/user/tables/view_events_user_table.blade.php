...
//Select del view, se puede usar para filtros
        $events = DB::table('events')->whereRaw('date>=now()')->orderBy('date', 'asc')->get();
...
<?php
        ...
        foreach ($events as $event) {
          echo "<tr>";
          echo "<td>";
          echo "<a href='http://".$_SERVER['HTTP_HOST']."/calendar/user/view_event_user?id=".$event->id."'>".$event->name."</a>";
          echo "</td>";
          echo "<td>";
