...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #d2d8d8;">
  ...
  <script>if (navigator.userAgent.indexOf('Mobile') !== -1) {
    ...
    document.write("<div onmouseover=\"this.style.background='#ffdca4';\" onmouseout=\"this.style.background='#d2d8d8';\" class=\"navbar_item\">");
    document.write("<a class=\"navbar-brand\" target=\"_blank\" style=\"color:orange\" href='https://wa.me/542944301742?text=Hola!'><img src='http://{{$_SERVER['HTTP_HOST']}}/img/whatsapp.png'>Whatsapp</a>&nbsp;");
    document.write("</div>");
